...
with_CondaEnv("HerperTestPkg", rco <- readSeqsumm(tumour.data=seqsumm_HCC1143)
 ,pathToMiniConda = "/var/folders/zy/x35d37h50sq2_fp3zrjydcl00000gn/T//Rtmpoq6zZP/r-miniconda")
...
Although we will not activate the environment, many tools can be used straight from the Conda environment's bin directory. When the result of **install_CondaTools()** is assigned to a variable, it will contain the path to the bin directory for that environment. Users ca
then run these tools with **System()** commands
