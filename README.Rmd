...
reticulate::conda_remove("herper", packages = NULL)
reticulate::conda_remove("herper2", packages = NULL)
reticulate::conda_remove("HerperTestPkg_0.1.0", packages = NULL)
reticulate::conda_remove("my_test", packages = NULL)
reticulate::conda_remove("seqCNA", packages = NULL)
```
...
knitr::include_graphics("inst/extdata/pkg_deps_bar_mask-1.png")
```
...
```{r import}
testYML <- system.file("extdata/test2.yml",package="Herper")
